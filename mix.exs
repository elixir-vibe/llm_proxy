defmodule LLMProxy.MixProject do
  ...
  defp deps do
    [
      ...
      {:quackdb, "~> 0.5.15"},
      # Temporary until a Hex release contains https://github.com/agentjido/req_llm/pull/897.
      {:req_llm, github: "agentjido/req_llm", ref: "c7036761aad967590b0bfc39ed6285142286e5cd"},
      {:req, "~> 0.6"},
